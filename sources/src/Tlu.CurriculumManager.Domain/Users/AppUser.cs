...
namespace Tlu.CurriculumManager.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update CurriculumManagerDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update CurriculumManagerEfCoreEntityExtensionMappings to extend the IdentityUser entity
