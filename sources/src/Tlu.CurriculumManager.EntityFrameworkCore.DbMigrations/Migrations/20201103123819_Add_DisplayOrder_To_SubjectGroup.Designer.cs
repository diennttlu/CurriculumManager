...
namespace Tlu.CurriculumManager.Migrations
{
    ...
    [Migration("20201103123819_Add_DisplayOrder_To_SubjectGroup")]
    partial class Add_DisplayOrder_To_SubjectGroup
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tlu.CurriculumManager.Curriculum", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Tlu.CurriculumManager.Faculty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Tlu.CurriculumManager.Outline", b =>
                {
                    ...
                    b.ToTable("AppOutlines");
                });

            modelBuilder.Entity("Tlu.CurriculumManager.OutlineDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AppOutlineDocuments");
                });

            modelBuilder.Entity("Tlu.CurriculumManager.SchoolYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AppSchoolYears");
                });

            modelBuilder.Entity("Tlu.CurriculumManager.Subject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Tlu.CurriculumManager.Teacher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Tlu.CurriculumManager.TeacherSubject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Tlu.CurriculumManager.Curriculum", b =>
                {
                    b.HasOne("Tlu.CurriculumManager.Major", "Major")
            ...
            modelBuilder.Entity("Tlu.CurriculumManager.OutlineDocument", b =>
                {
                    b.HasOne("Tlu.CurriculumManager.Document", "Document")
                        .WithMany("OutlineDocuments")
                        .HasForeignKey("DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Tlu.CurriculumManager.Outline", "Outline")
                        .WithMany("OutlineDocuments")
                        .HasForeignKey("OutlineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Tlu.CurriculumManager.Teacher", b =>
                {
                    b.HasOne("Tlu.CurriculumManager.Genre", "Genre")
                        .WithMany("Teachers")
            ...
            modelBuilder.Entity("Tlu.CurriculumManager.TeacherSubject", b =>
                {
                    ...
                    b.HasOne("Tlu.CurriculumManager.Teacher", "Teacher")
                        .WithMany("TeacherSubjects")
